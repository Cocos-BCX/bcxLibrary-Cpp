...
namespace bcx { namespace protocol {
    ...
    struct nh_relate_asset_operation : public graphene::chain::base_operation {
...
FC_REFLECT( bcx::protocol::nh_relate_asset_operation::fee_parameters_type,
           (fee)
           (price_per_kbyte)
           )

FC_REFLECT( bcx::protocol::nh_relate_asset_operation,
           (fee)
           (owner)
           )
