...
namespace bcx { namespace protocol {
    ...
    struct nh_register_creator_operation : public graphene::chain::base_operation {
...
FC_REFLECT( bcx::protocol::nh_register_creator_operation::fee_parameters_type,
           (fee)
           (price_per_kbyte)
           )

FC_REFLECT( bcx::protocol::nh_register_creator_operation,
           (fee)
           (fee_paying_account)
           )
